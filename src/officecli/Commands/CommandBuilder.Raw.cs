...
{
    private static Command CreateRawCommand(Option<bool> jsonOption)
    {
    ...
    private static Command CreateRawSetCommand(Option<bool> jsonOption)
    {
    ...
    private static Command CreateAddPartCommand(Option<bool> jsonOption)
    {
